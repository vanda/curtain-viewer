...
A viewer based on OpenSeaDragon for stacking images in superimposition, to examine differences incrementally between similar, or related images, supplied as canvases in a IIIF manifest.
...
(The [Compariscope](https://github.com/vanda/iiif-features) editor, can assist with preparing region of interest paramaters)
